...
void selectionSort(vector<int>& listaNumeros) {
    ...
    for (int i = 0; i < n - 1; i++) {
        ...
        if (minIndex != i) {
            swap(listaNumeros[i], listaNumeros[minIndex]);
        }
    }
}
...
int main(){
    ...
    std::ofstream archivo("lista_tiempos_selectionsort.txt");
