...
void insertionSort(vector<int>& listaNumeros) {
    ...
    for (int i = 1; i < n; i++) {
        ...
        // Mover los elementos del subarreglo ordenado hacia adelante
...
int main(){
    ...
    std::ofstream archivo("lista_tiempos_insertionsort.txt");
